 ...
 * @author Nehon
 */
public class OutBusPanel extends DraggablePanel implements ComponentListener, Selectable {
  ...
  //  private final MatPanel preview;
    ...
    public OutBusPanel(String name, Shader.ShaderType type) {
        ...
        GroupLayout outBusPanel1Layout = new GroupLayout(this);
        this.setLayout(outBusPanel1Layout);
        outBusPanel1Layout.setHorizontalGroup(
                outBusPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                .addGroup(GroupLayout.Alignment.TRAILING, outBusPanel1Layout.createSequentialGroup()
